...
import { Github, Instagram, Linkedin, MapPin, Phone, Mail, Clock, Scissors } from "lucide-react"
    ...
    <footer className="bg-gray-900 text-white pt-20 pb-10">
      <div className="container-custom">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Dwarka Mor New Delhi, India</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-6 w-6 text-primary mr-3" />
                <span className="text-gray-400">+91 8595703558</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-6 w-6 text-primary mr-3" />
                <span className="text-gray-400">3gtsyntax.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} GTSyntax. All rights reserved.</p>
          <p className="mt-2">
          </p>
        </div>
      </div>
